					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" enctype="multipart/form-data"data-parsley-validate class="form-horizontal form-label-left"action="{{route('storetestimonial')}}" method="post">
										@csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="image" name="filename" required="required" accept=".png,.jpg,.jpeg" class="form-control">
											</div>
										</div>
